...
## 1. Request Parameters  
    ...
    Date Completed:** 2022-03-04T14:52:09.522447  

    ID: 53344375-eaba-4c97-8961-a2fb9f4dbbfd  
    ...
    Details:  
        ...
        Coordinates:  
            ...
            US-NE2, Irrigated, 41.1649, -96.4071  
            US-NE3, Rainfed, 41.1797, -96.4397  
    
    Version: This request was processed by AppEEARS version 2.71  

## 2. Request File Listing  

- Comma-separated values file with data extracted for a specific product
  - Nebraska-All-MOD13A1-006-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - Nebraska-All-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - Nebraska-All-request.json
- xml file
  - Nebraska-All-MOD13A1-006-metadata.xml  
...
- Didan, K. (2015). MOD13A1 MODIS/Terra Vegetation Indices 16-Day L3 Global 500m SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2022-03-04 from https://doi.org/10.5067/MODIS/MOD13A1.006. Accessed March 4, 2022.

## 9. Software Citation  

AppEEARS Team. (2022). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.71. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed March 4, 2022. https://lpdaacsvc.cr.usgs.gov/appeears
