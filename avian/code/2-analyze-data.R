...
data_p<-read_rds('./avian/data/pro-data.rds')
...
ggsave(plot = plt, filename = './avian/output/sync_map.pdf', 
       width = 6, height = 4)
...
hfi <- terra::rast('./avian/data/wildareas-v3-1993-human-footprint.tif')
...
ggsave(plot = plt6, filename = './avian/output/sync_hfi.pdf',
       width = 6, height = 4)
