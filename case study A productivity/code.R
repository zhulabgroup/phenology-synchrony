...
# read in flux data
flux_df <- bind_rows(
  read_csv(paste0(path, "data/FLX_US-Ne2_FLUXNET2015_FULLSET_2001-2013_1-4/FLX_US-Ne2_FLUXNET2015_FULLSET_DD_2001-2013_1-4.csv")) %>%
    mutate(site = "IR"),
...
p_reg <- ggplot(evi_annual_df %>%
  ...
  ggpubr::stat_cor(
    aes(
      x = daymet_precip, y = value, group = interaction(metric, site),
